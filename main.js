...
const search=document.getElementById('search').addEventListener('click',()=>search_data('reactions'))
const emoji=document.getElementById('emoji').addEventListener('click',()=>emoji_data())


const api_key = "JGBHVBKkrV5ua6SZH4uHKd5oMbt4y5Cq";
...
// by default trending GIFs will be fetched
trending_data()